...
source("/Users/jcervas/Google Drive/School/UCI/R Functions/weighted.confint.R")
cmps <- read.dta("/Users/jcervas/Desktop/CMPSgraphs/CMPSclean.dta", convert.factors=FALSE)
