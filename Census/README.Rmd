...
Attach Libraries
```{r}
attachLibraries <- c("rgdal", "censusapi", "tigris", "tidyverse", "cartogram", "getcartr", "spdep", "rmapshaper")
...
county.2017.ACS5 <- getCensus(name="acs/acs5", vintage=2017, vars=c("B01001_001E","C02003_001E","C02003_002E","C02003_003E","C02003_004E"), region="county:261", regionin="state:13", key=key)
...
# bg.2017.ACS5 <- getCensusApi("https://api.census.gov/data/2017/acs/acs5?", key=key, get=c("C02003_001E","C02003_002E","C02003_003E","C02003_004E"), region = "for=block%20group&in=state:13%20county:261%20tract:*")
