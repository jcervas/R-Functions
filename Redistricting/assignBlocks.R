...
# Example - Minnesota 116th Congress, Census Blocks
	district_shp <- rgdal::readOGR("/Users/user/Library/Mobile Documents/com~apple~CloudDocs/Downloads/tl_2019_us_cd116/tl_2019_us_cd116.shp")
	block_shp <- rgdal::readOGR("/Users/user/Library/Mobile Documents/com~apple~CloudDocs/Downloads/tl_2019_27_tabblock10 2/tl_2019_27_tabblock10.shp")
...
# plot(district_shp, border="gray50", lwd=3)
	plot(mn_blocks, border = "#FFFFFF", col = mn_blocks@data$cols, lty=1, lwd = 0.25)
dev.off()
